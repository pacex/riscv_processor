...
##TODO set_property PULLUP true [get_ports P]
##TODO set_property PULLDOWN true [get_ports P]

## Clock signal
##set_property -dict { PACKAGE_PIN F14   IOSTANDARD LVCMOS33 } [get_ports { pad_xtal_in }]; #IO_L13P_T2_MRCC_15 Sch=uclk
#set_property PULLUP true [get_ports pad_xtal_in]
##create_clock -add -name sys_clk_pin -period 83.333 -waveform {0 41.667} [get_ports { pad_xtal_in }];
set_property -dict { PACKAGE_PIN R2    IOSTANDARD SSTL135 } [get_ports { BOARD_CLK }]; #IO_L12P_T1_MRCC_34 Sch=ddr3_clk[200]
create_clock -add -name sys_clk_pin -period 10.000 -waveform {0 5.000}  [get_ports { BOARD_CLK }];

## Switches
set_property -dict { PACKAGE_PIN H14   IOSTANDARD LVCMOS33 } [get_ports { BOARD_SWITCH[0] }]; #IO_L20N_T3_A19_15 Sch=sw[0]
...
## RGB LEDs
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { BOARD_LED_RGB0[0] }]; #IO_L23N_T3_FWE_B_15 Sch=led0_r
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { BOARD_LED_RGB0[1] }]; #IO_L14N_T2_SRCC_15 Sch=led0_g
set_property -dict { PACKAGE_PIN F15   IOSTANDARD LVCMOS33 } [get_ports { BOARD_LED_RGB0[2] }]; #IO_L13N_T2_MRCC_15 Sch=led0_b
set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { BOARD_LED_RGB1[0] }]; #IO_L15N_T2_DQS_ADV_B_15 Sch=led1_r
set_property -dict { PACKAGE_PIN F18   IOSTANDARD LVCMOS33 } [get_ports { BOARD_LED_RGB1[1] }]; #IO_L16P_T2_A28_15 Sch=led1_g
set_property -dict { PACKAGE_PIN E14   IOSTANDARD LVCMOS33 } [get_ports { BOARD_LED_RGB1[2] }]; #IO_L15P_T2_DQS_15 Sch=led1_b


## LEDs
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { BOARD_LED[0] }]; #IO_L16N_T2_A27_15 Sch=led[2]
set_property -dict { PACKAGE_PIN F13   IOSTANDARD LVCMOS33 } [get_ports { BOARD_LED[1] }]; #IO_L17P_T2_A26_15 Sch=led[3]
set_property -dict { PACKAGE_PIN E13   IOSTANDARD LVCMOS33 } [get_ports { BOARD_LED[2] }]; #IO_L17N_T2_A25_15 Sch=led[4]
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { BOARD_LED[3] }]; #IO_L18P_T2_A24_15 Sch=led[5]


## Buttons
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { BOARD_BUTTON[0] }]; #IO_L18N_T2_A23_15 Sch=btn[0]
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { BOARD_BUTTON[1] }]; #IO_L19P_T3_A22_15 Sch=btn[1]
set_property -dict { PACKAGE_PIN J16   IOSTANDARD LVCMOS33 } [get_ports { BOARD_BUTTON[2] }]; #IO_L19N_T3_A21_VREF_15 Sch=btn[2]
set_property -dict { PACKAGE_PIN H13   IOSTANDARD LVCMOS33 } [get_ports { BOARD_BUTTON[3] }]; #IO_L20P_T3_A20_15 Sch=btn[3]
...
## PMOD Header JB                    
set_property -dict { PACKAGE_PIN P17 IOSTANDARD LVCMOS33 } [get_ports { BOARD_VGA_R[0] }]; #IO_L11P_T1_SRCC_15 Sch=jb_p[1]
set_property -dict { PACKAGE_PIN P18 IOSTANDARD LVCMOS33 } [get_ports { BOARD_VGA_R[1] }]; #IO_L11N_T1_SRCC_15 Sch=jb_n[1]
set_property -dict { PACKAGE_PIN R18 IOSTANDARD LVCMOS33 } [get_ports { BOARD_VGA_R[2] }]; #IO_L12P_T1_MRCC_15 Sch=jb_p[2]
set_property -dict { PACKAGE_PIN T18 IOSTANDARD LVCMOS33 } [get_ports { BOARD_VGA_R[3] }]; #IO_L12N_T1_MRCC_15 Sch=jb_n[2]
set_property -dict { PACKAGE_PIN P14 IOSTANDARD LVCMOS33 } [get_ports { BOARD_VGA_B[0] }]; #IO_L23P_T3_FOE_B_15 Sch=jb_p[3]
set_property -dict { PACKAGE_PIN P15 IOSTANDARD LVCMOS33 } [get_ports { BOARD_VGA_B[1] }]; #IO_L23N_T3_FWE_B_15 Sch=jb_n[3]
set_property -dict { PACKAGE_PIN N15 IOSTANDARD LVCMOS33 } [get_ports { BOARD_VGA_B[2] }]; #IO_L24P_T3_RS1_15 Sch=jb_p[4]
set_property -dict { PACKAGE_PIN P16 IOSTANDARD LVCMOS33 } [get_ports { BOARD_VGA_B[3] }]; #IO_L24N_T3_RS0_15 Sch=jb_n[4]
                                     
## PMOD Header JC                    
set_property -dict { PACKAGE_PIN U15 IOSTANDARD LVCMOS33 } [get_ports { BOARD_VGA_G[0] }]; #IO_L20P_T3_A08_D24_14 Sch=jc_p[1]
set_property -dict { PACKAGE_PIN V16 IOSTANDARD LVCMOS33 } [get_ports { BOARD_VGA_G[1] }]; #IO_L20N_T3_A07_D23_14 Sch=jc_n[1]
set_property -dict { PACKAGE_PIN U17 IOSTANDARD LVCMOS33 } [get_ports { BOARD_VGA_G[2] }]; #IO_L21P_T3_DQS_14 Sch=jc_p[2]
set_property -dict { PACKAGE_PIN U18 IOSTANDARD LVCMOS33 } [get_ports { BOARD_VGA_G[3] }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=jc_n[2]
set_property -dict { PACKAGE_PIN U16 IOSTANDARD LVCMOS33 } [get_ports { BOARD_VGA_HSYNC }]; #IO_L22P_T3_A05_D21_14 Sch=jc_p[3]
set_property -dict { PACKAGE_PIN P13 IOSTANDARD LVCMOS33 } [get_ports { BOARD_VGA_VSYNC }]; #IO_L22N_T3_A04_D20_14 Sch=jc_n[3]
...
## USB-UART Interface
set_property -dict { PACKAGE_PIN R12   IOSTANDARD LVCMOS33 } [get_ports { BOARD_UART_TX }]; #IO_25_14 Sch=uart_rxd_out
set_property PULLUP true [get_ports BOARD_UART_TX]
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { BOARD_UART_RX }]; #IO_L24N_T3_A00_D16_14 Sch=uart_txd_in
set_property PULLUP true [get_ports BOARD_UART_RX]
...
#set_property -dict { PACKAGE_PIN G16   IOSTANDARD LVCMOS33 } [get_ports { pad_spim_sck }]; #IO_L14P_T2_SRCC_15 Sch=ck_io13_sck


## ChipKit I2C
#set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS33 } [get_ports { pad_i2c0_scl }]; #IO_L24N_T3_RS0_15 Sch=ck_scl
#set_property PULLDOWN true [get_ports pad_i2c0_sda]

#set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33 } [get_ports { pad_i2c0_sda }]; #IO_L24P_T3_RS1_15 Sch=ck_sda
#set_property PULLDOWN true [get_ports pad_i2c0_scl]


## Misc. ChipKit signals
#set_property -dict { PACKAGE_PIN K13   IOSTANDARD LVCMOS33 } [get_ports { ck_ioa }]; #IO_25_15 Sch=ck_ioa
set_property -dict { PACKAGE_PIN C18   IOSTANDARD LVCMOS33 } [get_ports { BOARD_RESN }]; #IO_L11N_T1_SRCC_15
#set_property PULLUP true [get_ports pad_reset_n]


## Quad SPI Flash
## Note: the SCK clock signal can be driven using the STARTUPE2 primitive
#set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { pad_spim_csn0 }]; #IO_L6P_T0_FCS_B_14 Sch=qspi_cs
...
#set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { pad_spim_sdio3 }]; #IO_L2N_T0_D03_14 Sch=qspi_dq[3]

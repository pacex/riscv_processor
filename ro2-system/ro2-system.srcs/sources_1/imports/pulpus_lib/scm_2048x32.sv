...
*/
    assign Q      = Q_int[0];
    assign Q_scm0 = Q_int_scm0[0];
    assign Q_scm1 = Q_int_scm1[0];
    ...
    //16 SCM Banks, each 128x32 bit
     ...
     begin : SCM_CUT
        ...
        assign CEN_int[i]       = CEN      ;
        assign CEN_scm0_int[i]  = CEN_scm0 ;
        assign CEN_scm1_int[i]  = CEN_scm1 ;

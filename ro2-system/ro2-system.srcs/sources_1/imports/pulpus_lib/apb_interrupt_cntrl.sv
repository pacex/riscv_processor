...
vio_4 your_instance_name (
       ...
       .probe_in0(rst_ni),    // input wire [0 : 0] probe_in0
       .probe_in1(core_irq_id_o),    // input wire [4 : 0] probe_in1
       .probe_in2(core_irq_req_o),    // input wire [0 : 0] probe_in2
       .probe_in3(core_irq_ack_i),    // input wire [0 : 0] probe_in3
       .probe_in4(core_irq_id_i),    // input wire [4 : 0] probe_in4
       .probe_in5(s_events),    // input wire [31 : 0] probe_in5
       .probe_in6(r_ack),    // input wire [31 : 0] probe_in6
       .probe_in7(r_int),    // input wire [31 : 0] probe_in7
       .probe_in8(r_mask),    // input wire [31 : 0] probe_in8
       .probe_in9(r_fifo_event),    // input wire [31 : 0] probe_in9
       .probe_in10(event_fifo_fulln_o),  // input wire [0 : 0] probe_in10
       .probe_in11(s_int_next)  // input wire [31 : 0] probe_in11
     );
    */ 
  generic_fifo 
  #( 

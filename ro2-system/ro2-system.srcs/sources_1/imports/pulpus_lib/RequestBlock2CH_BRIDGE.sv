...
(
    ...
    //weird behav simulator bug...
    wire [N_CH0+N_CH1-1:0] tmpSig;//={N_CH0+N_CH1{1'b0}};
    assign data_r_valid_CH1_o=tmpSig[N_CH0+N_CH1-1:N_CH0];
    assign data_r_valid_CH0_o=tmpSig[N_CH0-1:0];

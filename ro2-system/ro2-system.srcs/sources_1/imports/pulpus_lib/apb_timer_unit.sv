...
vio_3 your_instance_name (
         ...
         .probe_in0(HRESETn),    // input wire [0 : 0] probe_in0
         .probe_in1(PREADY),    // input wire [0 : 0] probe_in1
         .probe_in2(PADDR),    // input wire [31 : 0] probe_in2
         .probe_in3(PWDATA),    // input wire [31 : 0] probe_in3
         .probe_in4(PWRITE),    // input wire [0 : 0] probe_in4
         .probe_in5(PSEL),    // input wire [0 : 0] probe_in5
         .probe_in6(PENABLE),    // input wire [0 : 0] probe_in6
         .probe_in7(irq_lo_o),    // input wire [0 : 0] probe_in7
         .probe_in8(s_cfg_lo),    // input wire [31 : 0] probe_in8
         .probe_in9(s_timer_val_lo),    // input wire [31 : 0] probe_in9
         .probe_in10(s_timer_cmp_lo)  // input wire [31 : 0] probe_in10
       );*/
...
`ifndef PULP_FPGA_EMUL
  ...
  pulp_clk_sync_wedge_fpga i_ref_clk_sync
    (
     .clk_i(HCLK),
     .rstn_i(HRESETn),  
     .slower_clk_i(ref_clk_i),
     .r_edge_o(s_ref_clk_edge),
     //.f_edge_o(s_ref_clk_edge),
     .serial_o()
     );       
     `endif

...
module pulpissimo
#(
  parameter CORE_TYPE   = 1, // 0 for RISCY, 1 for ZERORISCY, 2 for MICRORISCY
  parameter USE_FPU     = 0,
...
(
  ...
  localparam AXI_ID_CLUSTER_SOC_WIDTH   = 1;
  
  //localparam AXI_ID_CLUSTER_SOC_WIDTH   = 7;
  //localparam AXI_ID_SOC_CLUSTER_WIDTH   = 8;
  
  localparam AXI_ID_SOC_CLUSTER_WIDTH   = 1;
  ...
  logic [31:0]                 s_gpio_in_overwrite;
  ...
  */
  wire s_boot_l2;
  assign s_cam_data = {pad_cam_data0,pad_cam_data1,pad_cam_data2,pad_cam_data3,
                       pad_cam_data4,pad_cam_data5,pad_cam_data6,pad_cam_data7}; 
  //assign s_rstn=resetn;
   ...
   */
assign s_gpio_in_overwrite = {s_gpio_in[31:19], s_cam_data, s_gpio_in[10:0]};
   // SOC DOMAIN
   soc_domain #(
      .CORE_TYPE          ( CORE_TYPE                ),
      .USE_FPU            ( USE_FPU                  ),
